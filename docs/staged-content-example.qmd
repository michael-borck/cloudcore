---
title: "CloudCore Security Documentation"
---

<script src="../scripts/staged-access.js"></script>
...
**Employee Interview - IT Manager Raj Patel:**
> "We had to disable the password policy because the executives complained too much. The CEO's password has been 'CloudCore123' for two years."
...
- `cloudcore_support`: Shared account, password on sticky note
...
<button class="btn btn-secondary" onclick="cloudcoreAccess.clearAccess()">Clear Access</button>
<button class="btn btn-info" onclick="cloudcoreAccess.requestAccess('consultant')">Request Consultant</button>
<button class="btn btn-warning" onclick="cloudcoreAccess.requestAccess('auditor')">Request Auditor</button>
</div>
