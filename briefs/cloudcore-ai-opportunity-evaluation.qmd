...
For the full interview, see the [CEO chatbot profile](https://cloudcore.serveur.au/chatbots/bots/marcell_ziemann/).
...
For the full interview, see the [CTO chatbot profile](https://cloudcore.serveur.au/chatbots/bots/mark_gonzalez/).
...
For the full interview, see the [COO chatbot profile](https://cloudcore.serveur.au/chatbots/bots/sarah_thompson/).
...
For the full interview, see the [CISO chatbot profile](https://cloudcore.serveur.au/chatbots/bots/sophia_martines/) and the [security policies](https://cloudcore.serveur.au/docs/policies/) on the Cloudcore website.
...
- **Executive interviews:** Individual chatbot profiles for each executive are available at [cloudcore.serveur.au/chatbots/](https://cloudcore.serveur.au/chatbots/), where students can ask follow-up questions about positions and concerns
- **Security incident documentation:** Incident logs, articles, and policy documents at [cloudcore.serveur.au/docs/](https://cloudcore.serveur.au/docs/) provide context for the breach that shapes executive attitudes toward risk
- **Financial and operational data:** Raw datasets including customer, sales, and support data are available at [cloudcore.serveur.au/data/](https://cloudcore.serveur.au/data/) for independent analysis
