...
| Reference | Status |
|-----------|--------|
| Chatbot profiles at cloudcore.serveur.au/chatbots/ | SOURCED — real pages |
| Security docs at cloudcore.serveur.au/docs/ | SOURCED — real pages |
| Data files at cloudcore.serveur.au/data/ | SOURCED — real pages |
