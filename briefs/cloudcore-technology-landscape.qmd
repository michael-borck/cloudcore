...
- **System and network documentation:** The support section at [cloudcore.eduserver.au/docs/support/](https://cloudcore.eduserver.au/docs/support/) includes network diagrams, the ERD, and the organisational chart
- **Security policies:** Current security and compliance policies are published at [cloudcore.eduserver.au/docs/policies/](https://cloudcore.eduserver.au/docs/policies/), including the access control, change management, and data classification policies referenced in this document
- **Incident logs:** Detailed logs from the September 2024 breach, including VPN, database, firewall, and SIEM entries, are available at [cloudcore.eduserver.au/docs/logs/](https://cloudcore.eduserver.au/docs/logs/)
